vms = {
  ...
  "k8s-worker-plat" = { vm_id = 2440, ip = "172.16.30.40", vlan = 30, bridge = "vmbr0", node = "kosa24", cores = 6, memory = 12288, disk_size = 80, template_vm_id = 9005, storage_ip = "10.10.10.210", storage_bridge = "vmbr1", storage_cidr = 24, tags = ["k8s-worker", "platform", "ingress", "argocd"], protection = true }
