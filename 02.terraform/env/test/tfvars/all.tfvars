vms = {
  ...
  "k8s-worker-01"   = { vm_id = 12141, ip = "172.16.30.141", vlan = 30, bridge = "vmbr0", storage_ip = "10.10.10.241", storage_bridge = "vmbr1", storage_cidr = 24, node = "kosa21", memory = 12288, template_vm_id = 9005 }
  "k8s-worker-02"   = { vm_id = 12242, ip = "172.16.30.142", vlan = 30, bridge = "vmbr0", storage_ip = "10.10.10.242", storage_bridge = "vmbr1", storage_cidr = 24, node = "kosa22", memory = 12288, template_vm_id = 9005 }
  "k8s-worker-03"   = { vm_id = 12343, ip = "172.16.30.143", vlan = 30, bridge = "vmbr0", storage_ip = "10.10.10.243", storage_bridge = "vmbr1", storage_cidr = 24, node = "kosa23", memory = 12288, template_vm_id = 9005 }
  "registry"        = { vm_id = 12150, ip = "172.16.30.150", vlan = 30, bridge = "vmbr0", node = "kosa21", tags = ["service-registry", "harbor"] }
  "cicd"            = { vm_id = 12455, ip = "172.16.30.155", vlan = 30, bridge = "vmbr0", node = "kosa24", tags = ["service-cicd", "gitea", "actions-runner"] }
