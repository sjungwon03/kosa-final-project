vms = {
  ...
  # [3] DNS Servers
  "dns1"            = { vm_id = 2211, ip = "172.16.30.11", vlan = 30, bridge = "vmbr0", node = "kosa22", tags = ["infra-dns", "coredns", "etcd"] }
  "dns2"            = { vm_id = 2312, ip = "172.16.30.12", vlan = 30, bridge = "vmbr0", node = "kosa23", tags = ["infra-dns", "coredns", "etcd"] }

  # [4] Security Servers
  "vault1"          = { vm_id = 2121, ip = "172.16.30.21", vlan = 30, bridge = "vmbr0", node = "kosa21", tags = ["infra-security", "vault", "pki"] }
  "vault2"          = { vm_id = 2422, ip = "172.16.30.22", vlan = 30, bridge = "vmbr0", node = "kosa24", tags = ["infra-security", "vault", "pki"] }
