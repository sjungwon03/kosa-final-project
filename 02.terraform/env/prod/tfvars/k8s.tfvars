vms = {
  ...
  "k8s-master-01"   = { vm_id = 2131, ip = "172.16.30.31", vlan = 30, bridge = "vmbr0", node = "kosa21", memory = 8192, disk_size = 35, template_vm_id = 9005, datastore_id = "local-lvm", storage_ip = "10.10.10.200", storage_bridge = "vmbr1", storage_cidr = 24, tags = ["k8s-master", "control-plane"] }
