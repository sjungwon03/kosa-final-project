vms = {
  ...
  "k8s-worker-plat" = { vm_id = 2440, ip = "172.16.30.40", vlan = 30, bridge = "vmbr0", node = "kosa24", cores = 12, memory = 16384, disk_size = 35, template_vm_id = 9005 }
  "k8s-worker-01"   = { vm_id = 2145, ip = "172.16.30.45", vlan = 30, bridge = "vmbr0", node = "kosa21", memory = 4096, disk_size = 35, template_vm_id = 9005 }
  "k8s-worker-02"   = { vm_id = 2246, ip = "172.16.30.46", vlan = 30, bridge = "vmbr0", node = "kosa22", memory = 4096, disk_size = 35, template_vm_id = 9005 }
  "k8s-worker-03"   = { vm_id = 2347, ip = "172.16.30.47", vlan = 30, bridge = "vmbr0", node = "kosa23", memory = 4096, disk_size = 35, template_vm_id = 9005 }
}
