...
│                   VIP: 172.16.30.30                             │
│         ┌──────────────────────────────────────────┐            │
│         │ haproxy-1 (172.16.30.20) - pve1          │            │
│         │ haproxy-2 (172.16.30.21) - pve2          │            │
│         └──────────────────────────────────────────┘            │
...
│                   VIP: 172.16.30.35                             │
│         ┌──────────────────────────────────────────┐            │
│         │ proxysql-1 (172.16.30.25) - pve3         │            │
│         │ proxysql-2 (172.16.30.26) - pve4         │            │
│         └──────────────────────────────────────────┘            │
...
172.16.30.2-9  - Reserved
172.16.30.10   - pxc-1 (Bootstrap)
172.16.30.11   - pxc-2
172.16.30.12   - pxc-3
172.16.30.20   - haproxy-1
172.16.30.21   - haproxy-2
172.16.30.25   - proxysql-1
172.16.30.26   - proxysql-2
172.16.30.30   - HAProxy VIP
172.16.30.35   - ProxySQL VIP
```
...
```bash
# Stats 인터페이스 접속
http://172.16.30.20:8404/stats
http://172.16.30.21:8404/stats
```

**ProxySQL 확인**:
```bash
# Admin 연결
mysql -h172.16.30.25 -P6032 -uadmin -padmin
...
**Admin Interface (Port 6032)**:
```bash
mysql -h172.16.30.25 -P6032 -u admin -padmin
# 구성 관리
# 쿼리 통계
# 커넥션 모니터링
```
...
**Stats Interface**: http://172.16.30.20:8404/stats
